...
# --------------------------------------------------------------
# filtering out most of the noise to clearly see the seasonal pattern 
fs = 1000 / 200 
...
#we have to make an algorithm which can spot 5 reps as this is a heavy bench press 
# This is a heavy set so this should have 5 sets in here
# doimain knowledge is indeed important!!--------------------------------------------------------------
...
def count_reps(dataset , cutoff = 0.4, order= 10, column = "acc_r"):
    ...
    # This function returns the indices of the extrema values in the numpy array. hence .values
    ...
    return len(peaks)
# reverese engineering to find set of parameters which can accurately predict the correct number of repetitions.
